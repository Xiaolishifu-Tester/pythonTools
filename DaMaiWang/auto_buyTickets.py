...
#大麦网主页
dmw_url = "https://www.damai.cn/"
#登录页面
login_url = "https://passport.damai.cn/login?ru=https%3A%2F%2Fwww.damai.cn%2F"
#抢票目标页
buy_url = "https://detail.damai.cn/item.htm?spm=a2oeg.search_category.0.0.7f124d154yofGg&id=832132381784&clicktitle=%E8%8B%8F%E5%B7%9E%20%E2%80%A2%E3%80%8C%E5%A4%9C%E7%9A%84%E7%AC%AC%E4%B8%80%E7%AB%A0%EF%BC%9A%E8%B5%B7%E7%82%B9%E3%80%8D%E6%96%B0%E7%94%9F%E4%BB%A3rapper%E7%9A%84%E9%9B%86%E7%BB%93"
...
class Concert:
    def __init__(self):
        ...
        # self.driver = webdriver.Chrome(executable_path=r'C:\Program Files\Google\Chrome\Application\chrome.exe')        # 默认Chrome浏览器

    def set_cookie(self):
        self.driver.get(dmw_url)
        print("###请点击登录###")
        while self.driver.title.find('大麦网-全球演W出赛事官方购票平台') != -1:
            time.sleep(1)
        print('###请扫码登录###')
    ...
    def check_order(self):
        if self.status in [3,4,5]:
            ...
            try:
                # 默认选第一个购票人信息
                self.driver.find_element('//*[@id="container"]/div/div[2]/div[2]/div[1]/div/label').click()
            except Exception as e:
